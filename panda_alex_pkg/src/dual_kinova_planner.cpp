...
class DualKinovaPlanner {
    ...
    std::string solve_tprm(bool solve_updated_version, int numSamples, double costEdgeThreshold)
    {
        ...
        tprm::TemporalPRM tprm(g_planning_scene, kinematic_model, kinematic_state);
        ...
        ///// SOLVING PRM //////
        tprm::Vector7d start_tprm(start_joint_pose_left);
        tprm::Vector7d end_tprm(goal_joint_pose_left);
